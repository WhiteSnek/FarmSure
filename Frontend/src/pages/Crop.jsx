  ...
  const getPrediction = async () => {
    ...
    try {
      const promises = files.map(async (fileArr) => {
        ...
        const res = await fetch(`${process.env.DISEASE_MODEL_URI}/model/train`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ data: file.base64Data, name: file.name }),
        });
        ...
        return {
          ...
          confidence: result.percentage.toFixed(2),
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button 
            ...
            style={{
              padding: '12px 24px',
              backgroundColor: files.length === 0 || isLoading ? '#d1d5db' : '#3b82f6',
              color: 'white',
              border: 'none',
              borderRadius: '8px',
              fontSize: '16px',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h1 style={{
                    ...
                    Let <span style={{ color: '#60a5fa' }}>technology</span> watch over your fields.
                  </h1>
                  <p style={{
                    fontSize: '18px',
                    margin: 0,
                    ...
                    You <span style={{ color: '#60a5fa' }}>focus</span> on growth, we'll handle the threats
                  </p>
                </div>
              </div>
            </div>
